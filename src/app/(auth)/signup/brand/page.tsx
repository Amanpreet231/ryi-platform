    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 bg-gradient-to-b from-zinc-950 to-black">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Join as a Brand</h1>
          <p className="mt-2 text-zinc-400">Create your account and start hiring influencers</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Input
                ...
                name="email"
                type="email"
                placeholder="priya@fashionforward.com"
