...
import { Handshake, CheckCircle, IndianRupee, Clock } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-400">Manage your collaborations with influencers</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-zinc-400">Awaiting Payment</p>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      ...
                      {deal.status === 'paid' && (
                        <p className="text-xs text-zinc-400">Paid to influencer</p>
                      )}
                    </div>
                  </div>
                </div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-zinc-400">
              {filter === 'all' 
                ? 'Accept applications to create deals'
